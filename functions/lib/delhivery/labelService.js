...
exports.generateShippingLabel = functions.https.onCall({ region: 'asia-south1', enforceAppCheck: false }, async (request) => {
    ...
    try {
        ...
        // Fallback for demo
        if (((_b = error.response) === null || _b === void 0 ? void 0 : _b.status) === 401 || ((_c = error.response) === null || _c === void 0 ? void 0 : _c.status) === 403 || ((_d = error.response) === null || _d === void 0 ? void 0 : _d.status) === 400) {
            return {
                success: true,
